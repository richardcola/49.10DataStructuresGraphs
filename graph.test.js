...
describe("addEdge", function() {
  it("should add appropriate edges to adjacency list", function() {
    let graph = new Graph();
    let a = new Node("A");
    let b = new Node("B");
    let c = new Node("C");
...
describe("removeEdge", function() {
  it("should remove vertices from adjacency list", function() {
    let graph = new Graph();
    let a = new Node("A");
    let b = new Node("B");
    let c = new Node("C");
...
describe("removeVertex", function() {
  it("should remove vertex as well as any edges", function() {
    let graph = new Graph();
    let a = new Node("A");
    let b = new Node("B");
    let c = new Node("C");
...
describe("DFS", function() {
  it("return an array of nodes searched using DFS", function() {
    let graph = new Graph();
    let S = new Node("S");
    let P = new Node("P");
    let U = new Node("U");
...
describe("BFS", function() {
  it("should return an array of nodes searched using BFS", function() {
    let graph = new Graph();
    let S = new Node("S");
    let P = new Node("P");
    let U = new Node("U");
